...
public class OrderStatusUpdateHandler {
    ...
    private void updateOrder(PurchaseOrder purchaseOrder) {
        // Idempotency check to prevent re-processing
        if (purchaseOrder.getOrderStatus() != OrderStatus.ORDER_CREATED) {
            return;
        }
        ...
        //  Explicitly save to ensure JPA updates the DB
        repository.save(purchaseOrder);

        //  Send compensating event if payment failed
